...
public class PID{
     ...
     */
    public double getCorrection(double actual, double setpoint){
        double output;
        double Poutput;
        double Ioutput;
        double Doutput;
    ...
    public double getCorrection(){
        return getCorrection(lastActual,setpoint);
    }
     ...
     * @return calculated output value for driving the system
     */
    public double getCorrection(double actual){
        return getCorrection(actual,setpoint);
    }

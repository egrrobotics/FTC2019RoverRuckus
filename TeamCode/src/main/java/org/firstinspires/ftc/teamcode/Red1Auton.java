...
public class Red1Auton extends RedAuton {
    public void addFinalCommands() {
        ...
        commands.add(new DriveForward(-.8,DriveForward.YLESSTHAN,.85,-90)); //This plus drive to glyph box w/ correction is -10
        commands.add(new ResetDriveEncoders());
        commands.add(new WaitForTime(100));
        ...
        commands.add(new DriveForward(-3.5,DriveForward.YLESSTHAN,.75,-90, false, true)); //This plus drive to glyph box w/ correction is -10
        commands.add(new WaitForTime(50));
        commands.add(new ResetDriveEncoders());
        commands.add(new WaitForTime(100));
